...
Zauważmy, że kolumny `option` i `result` są teraz wypełnione.
...
Istnieje kilka wygodnych funkcji przeznaczonych do zestawów przepływów pracy, w tym `collect_metrics()` do zestawiania statystyk wydajności.
